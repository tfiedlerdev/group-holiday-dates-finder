...
import { DateRange } from "../date_picker";
import { formatDate } from "../lib/dates";

export function SelectedRanges({ ranges, onRangeRemove, currentUsername }: { ranges: DateRange[], onRangeRemove: (rangeId: string) => void, currentUsername: string }) {
    return <>({ranges.filter(r => r.username === currentUsername).length > 0 && (
